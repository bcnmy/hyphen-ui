...
function Navbar({ showUserInfoModal }: INavbarProps) {
  ...
  return (
    <header className="sticky top-0 flex items-center justify-between px-6 py-3 text-white bg-black shadow-sm bg-opacity-20 backdrop-blur-sm border-opacity-20">
      <Link to="/bridge">
        <img
