      ...
      {state => (
        ...
        >
          ...
          {showEthereumDisclaimer ? (
            <article className="mt-2 flex h-10 items-center justify-center rounded-full bg-[#FF000040] px-8 text-xxxs font-bold uppercase text-[#FF0000] xl:h-9 xl:text-xxs">
